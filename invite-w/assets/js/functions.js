...
function hasWon(){
	...
	terminalTextArray.push("access granted!","invitation[part1]","help us debug the bug of all bugs: ethics in connected devices","","Wednesday, May 9th","18:00-21:00","Venue To Be Revealed","Shoreditch, London","DRINKS AND PIZZA","","join us for a workshop to understand ethical reflection and decision-making","when creating IOT devices","we hope to learn from you","and create ideas with you","about how to [keep | bring | remember] ethics","during the design+dev process","the <a href='http://www.ciid.dk' id='firstHref' target='_blank'>Copenhagen Institute of Interaction Design</a> will run the workshop","as part of research project <a href='http://virteuproject.eu' id='secondHref' target='_blank'> VIRT-EU </a>","we will use your inputs to start building tools","to try to support ethical reflection and decision-making","when designing connected things","",
